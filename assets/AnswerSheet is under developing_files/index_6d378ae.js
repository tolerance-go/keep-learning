...
;define("translation:widget/translate/common/hash",function(t,n,e){"use strict";function o(t){return void 0!==s[t]}function i(t){return"string"==typeof t&&t.length>0&&t.length<=l.MAX_URL_COUNT
}function r(t){t&&t.length>l.MAX_URL_COUNT&&a.set("isInRtTransState",!1)}var a=t("translation:widget/common/environment"),l=t("translation:widget/common/config/trans"),s=t("translation:widget/common/config/langMap"),c={};
c.set=function(t,n,e){e=encodeURIComponent(e);var l,s=o(t),f=o(n),h=i(e);if(r(e),s&&f&&h)l=[t+"/",n+"/",e];else if(s&&f)l=[t+"/",n+"/"];
else{if(!s)return void c.empty();l=[t+"/"]}location.hash==="#"+l.join("")&&a.set("isInRtTransState",!1),location.hash=l.join("")
},c.get=function(){var t,n,e=location.hash;try{e=decodeURIComponent(e)}catch(o){}if(e=e.replace(/^\#/,""),e.indexOf("/")>0)t=e.split("/"),n=t.length>3?{from:t[0],to:t[1],query:t.splice(0,2)&&t.join("/")}:3===t.length?{from:t[0],to:t[1],query:t[2]}:2===t.length?{from:t[0],to:t[1],query:""}:1===t.length?{from:t[0],to:"",query:""}:!1;
else if(t=e.split("|"),2===t.length){var i=t[1];t=t[0].split("2"),n=2===t.length?{from:t[0],to:t[1],query:i}:{from:t[0],to:"",query:i}
}else 1===t.length?(t=t[0].split("2"),n=2===t.length?{from:t[0],to:t[1],query:""}:{from:t[0],to:"",query:""}):n=!1;return n
},c.empty=function(){history.replaceState?history.replaceState("",document.title,location.pathname):location.hash=""},e.exports=c
});
...
;define("translation:widget/translate/details/appRead/appRead",function(t,n,i){"use strict";var a=t("translation:widget/common/third_party/template"),e=$("#left-result-container"),o={init:function(){this.bindEvents()
},bindEvents:function(){e.on("click","#app-read",function(){_hmt.push(["_trackEvent","首页","98_首页页面_结果页导流条点击"]),window.open("https://fanyi.baidu.com/appdownload/download.html")
})},build:function(){var t=a("tplAppRead",{});e.prepend(t),_hmt.push(["_trackEvent","首页","97_首页页面_结果页导流条展现"])}};$(function(){o.init()
}),i.exports=o});
...
;define("translation:widget/translate/output/adcards",function(t,n){"use strict";var a=t("translation:widget/common/environment"),e=t("translation:widget/common/third_party/template"),d=t("translation:widget/common/cookie"),o=window.common.hasSideAd,i=window.common.hasBottomBannerAd,r=$("#transOtherRight"),p=function(){if(!o)return{};
var t=$("#sideAdData");return{path:t.attr("data-path"),url:t.attr("data-url"),title:t.attr("data-title"),showad:t.attr("data-showad")||0}
}(),s=void 0,h=void 0,c={buildAd:function(){var t="0"===d.getCookie("HISTORY_SWITCH"),n=e("tplSideAd",{hasSideAd:o,sideAdData:p,isLong:t&&!i});
r.append(n),s=r.find(".app-side-ad"),h=r.find(".trans-side-ad-wrap")},bindEvents:function(){$(".translate-wrap").on("click",".app-side-ad.long",function(){_hmt.push(["_trackEvent","首页","90_首页页面_初始状态长banner点击"]),window.open("https://fanyi.baidu.com/appdownload/download.html")
}).on("click",".app-side-ad:not(.long)",function(){var t=a.get("hasDetail");_hmt.push(t?["_trackEvent","首页","94_首页页面_结果页右侧banner点击"]:["_trackEvent","首页","92_首页页面_初始状态右侧banner点击"]),window.open("https://fanyi.baidu.com/appdownload/download.html")
}),$(".translate-wrap").on("click",".showad-close-btn",function(t){$(".trans-side-ad-wrap").hide();var n=(new Date).getTime(),a=Math.floor(n/864e5);
d.setCookie("sideAdClose",a),_hmt.push(["_trackEvent","首页","web端侧边栏广告关闭点击"]),t.preventDefault(),t.stopPropagation()}).on("click",".side-ad-link",function(){_hmt.push(["_trackEvent","首页","web端侧边栏图文广告链接点击"])
})},updateAppSideAdLong:function(){var t=a.get("hasDetail"),n=a.get("isInHistoryMode"),e=!t&&!n&&!i;return s.toggleClass("long",e),e
},hideAppQr:function(){window.common.hasSideAd&&h.hide(),s.removeClass("detail-qr");var t=c.updateAppSideAdLong();s.show(),_hmt.push(t?["_trackEvent","首页","89_首页页面_初始状态长banner展现"]:["_trackEvent","首页","91_首页页面_初始状态右侧banner展现"])
},showAppQr:function(){o?(h.show(),s.hide(),_hmt.push(["_trackEvent","首页","web端侧边栏广告生成"]),_hmt.push(["_trackEvent","首页","web端侧边栏广告总展现"])):(s.addClass("detail-qr"),c.updateAppSideAdLong(),s.show(),_hmt.push(["_trackEvent","首页","93_首页页面_结果页右侧banner展现"]))
}};$(function(){c.buildAd(),c.bindEvents()}),n.hideAppQr=function(){c.hideAppQr()},n.showAppQr=function(t){c.showAppQr(t)
},n.updateAppSideAdLong=function(){c.updateAppSideAdLong()}});
...
;define("translation:widget/translate/details/details",function(e,a,t){"use strict";function s(a,t,s,N,O){var C=null,E=null,I=null,W="",q={0:"translator",1:"keyWord",2:"simpleMeaning",3:"oxford",4:"collins",5:"en2en",6:"zh2en",7:"zh2zh",8:"illSen",9:"wordColl",10:"webMeaning",11:"synonym",12:"rootsaffixes",13:"usecase",14:"sanyms",15:"etym"},B={translator:!1,keyWord:!1,simpleMeaning:!1,festivalLink:window.festivalLinkInfo.isShowFestivalLink,adLink:window.adLinkInfo.isShowAdLink,oxford:!1,collins:!1,en2en:!1,zh2en:!1,zh2zh:!1,illSen:!1,wordColl:!1,webMeaning:!1,synonym:!1,rootsaffixes:!1,usecase:!1,sanyms:!1,etym:!1};
!function(){if(!a.dict_result||"en"!==s&&"zh"!==s&&"jp"!==s&&"th"!==s)C=!1,b.sendIndexBannerLog();else if(a.dict_result.content)O||(C=a.dict_result,W=JSON.stringify(a.dict_result));
else if(a.dict_result.simple_means&&!O&&(C=a.dict_result.simple_means,E=a.dict_result.baike_img_url,I=a.dict_result.queryExplainVideo,a.dict_result.simple_means.symbols&&a.dict_result.simple_means.symbols.length>0&&(W=JSON.stringify({simple_means:{symbols:a.dict_result.simple_means.symbols}})),a.dict_result.sim_words&&(C.sim_words=a.dict_result.sim_words),a.dict_result.net_means&&(C.net_means=a.dict_result.net_means)),"zh"===t&&"en"===s||"en"===t&&"zh"===s)for(var e in a.dict_result)if(a.dict_result[e]instanceof Object&&!$.isEmptyObject(a.dict_result[e])&&0!==a.dict_result[e].length)switch(e){case"collins":B.collins=!0;
break;case"synthesize_means":B.zh2en=!0;break;case"zdict":B.zh2zh=!0;break;case"edict":B.en2en=!0;break;case"oxford":B.oxford=!0;
break;case"general_knowledge":a.dict_result.general_knowledge.similar_words&&(B.wordColl=!0);break;case"netdata":B.webMeaning=!0;
break;case"synonym":B.synonym=!0;break;case"rootsaffixes":B.rootsaffixes=!0;break;case"usecase":B.usecase=!0;break;case"sanyms":B.sanyms=!0;
break;case"etym":B.etym=!0}B.simpleMeaning=Boolean(C),!a.liju_result||"en"!==s&&"zh"!==s||!a.liju_result["double"]&&!a.liju_result.single||(B.illSen=!0),a.trans_result&&a.trans_result.keywords&&a.trans_result.keywords.length>0&&("zh"===t&&"en"===s||"en"===t&&"zh"===s)&&!B.simpleMeaning&&(B.keyWord=!0),a.simworks&&"[object Object]"===Object.prototype.toString.call(a.simworks)&&(B.translator=!0)
}();var D=[],F=!1;!function(){if(e("translation:widget/translate/sideNav/navSorter/listOperator").getNavList().forEach(function(e){var a=q[e];
B[a]&&D.push(a)}),B.festivalLink||B.adLink){var a=[];B.festivalLink&&a.push("festivalLink"),B.adLink&&a.push("adLink"),"simpleMeaning"!==D[0]?(D.unshift.apply(D,a),B.adLink&&B.festivalLink&&(F=!0)):D.splice.apply(D,[1,0].concat(a))
}var t=D.find(function(e){return"festivalLink"!==e&&"adLink"!==e});n.set("firstModuleId",parseInt(Object.keys(q).find(function(e){return q[e]===t
}),10))}();var A=a.dict_result;D.forEach(function(e){switch(e){case"translator":l.build(a.simworks);break;case"keyWord":k.build({data:a.trans_result.keywords,from:t,to:s});
break;case"simpleMeaning":c.buildSimpleMeans({data:C,to:s,baikeImgUrl:E,queryExplainVideo:I});break;case"festivalLink":d.buildFestivalLink();
break;case"adLink":o.build(F);break;case"oxford":z.init(A.oxford);break;case"collins":_.buildCollins({data:A.collins});break;
case"en2en":u.buildEdict({data:A.edict});break;case"zh2en":p.buildDict({data:A.synthesize_means});break;case"zh2zh":m.buildZdict({data:A.zdict});
break;case"illSen":g.buildSample({data:a.liju_result,from:t,to:s,query:N,badCaseByForce:O});break;case"wordColl":h.buildGeneral({data:A.general_knowledge});
break;case"webMeaning":v.buildWebMeans({data:A});break;case"synonym":L.buildSynonym({data:A.synonym});break;case"rootsaffixes":x.buildRootsaffixes({data:A.rootsaffixes});
break;case"usecase":S.buildUsecase({data:A.usecase});break;case"sanyms":M.buildSanyms({data:A.sanyms});break;case"etym":j.buildEtym({data:A.etym})
}});var J=!1;for(var R in B)J=J||B[R];J&&("en"===t&&"zh"===s&&N.length<417&&window.common.hasSideAd&&r.build(),n.set("hasDetail",!0),i.showAppQr(F)),f.init({from:t,to:s,query:N,dictJSON:W}),"en"===t&&"zh"===s||"zh"===t&&"en"===s?(w.genCollapse(),y.genNav()):y.destroyNav()
}{var n=e("translation:widget/common/environment"),i=e("translation:widget/translate/output/adcards"),l=e("translation:widget/translate/details/translator/translator"),r=e("translation:widget/translate/details/appRead/appRead"),d=e("translation:widget/translate/details/festivalLink/festivalLink"),o=e("translation:widget/translate/details/adLink/adLink"),c=e("translation:widget/translate/details/dictionary/simplemeans"),u=e("translation:widget/translate/details/edict/edict"),m=e("translation:widget/translate/details/zdict/zdict"),k=e("translation:widget/translate/details/keywords/keywords"),b=e("translation:widget/translate/output/bottomBanner"),f=e("translation:widget/translate/input/inputFavo"),y=e("translation:widget/translate/sideNav/sideNav"),w=e("translation:widget/translate/details/collapse/collapse"),g=e("translation:widget/translate/details/sample/sample"),_=e("translation:widget/translate/details/collins/collins"),p=e("translation:widget/translate/details/zhenDict/zhenDict"),h=e("translation:widget/translate/details/general/general"),v=e("translation:widget/translate/details/webMeans/webMeans"),z=e("translation:widget/translate/details/oxford/oxford"),L=e("translation:widget/translate/details/synonym/synonym"),x=e("translation:widget/translate/details/rootsaffixes/rootsaffixes"),S=e("translation:widget/translate/details/usecase/usecase"),M=e("translation:widget/translate/details/sanyms/sanyms"),j=e("translation:widget/translate/details/etym/etym");
...
},checkResponse:function(t,e){this.result=$.extend(!0,{},t||{});var a=t.res;return a.error?void(999===parseInt(a.error,10)?(this.clearOutputWrap(),o.normaltrans({data:{data:[{dst:a.query,src:a.query,result:[]}]}},t.query)):998===parseInt(a.error,10)?window.location.reload():997===parseInt(a.error,10)?alert("浏览器cookie功能被禁，请开启此功能"):this.showTimeout(a.errShowMsg)):void this.execResponse(t,e)
},showTimeout:function(t){t=t||"非常抱歉，翻译结果响应超时，请稍后再试!";var e={message:t},a=n("tplLongTextPrompt",e);$(".output-wrap").html(a)
},execResponse:function(t,e){var a=t.res,n=t.from,r=t.to,i=t.query,u=t.badCaseByForce;!e&&_hmt.push(["_trackEvent","首页","web端总共query数"]),a&&(this.clearOutputWrap(),a.trans_result&&o.normaltrans({data:a.trans_result}),s.init(a,n,r,i,u))
},clearOutputWrap:function(){a.set("hasDetail",!1),r.hideAppQr(),$(".textarea-bg-text").html(""),i.isout(),a.get("needLongtextTip")===!0?($(".output-wrap .output-mod").remove(),a.set("needLongtextTip",!1)):$(".output-wrap").empty().addClass("output-blank"),l.empty()
...
;define("translation:widget/translate/input/clear",function(t,n){"use strict";var a=t("translation:widget/translate/input/textarea"),e=t("translation:widget/translate/input/soundicon"),r=t("translation:widget/translate/input/correct"),i=t("translation:widget/translate/input/prompt"),s=t("translation:widget/translate/output/output"),l=t("translation:widget/translate/output/bottomBanner"),o=t("translation:widget/translate/input/hash"),u=t("translation:widget/translate/input/inputSug"),c=t("translation:widget/translate/input/inputFavo"),d=t("translation:widget/translate/sideNav/sideNav"),p=t("translation:widget/translate/docTranslate/docTransUtil"),h={clearBtn:$(".textarea-clear-btn"),clearInput:function(n){i.hide(),e.hide(),c.resetBtn(),this.hideIcon(),r.hide(),a.empty(n),u.clearAndHideSug(),p.clearDocTrans(),t("translation:widget/translate/input/dataTransfer").clearInputImage();
var s=$(".translateio");if(s.hasClass("is-zoom-in")){$(".translateio").removeClass("is-zoom-in");try{$(window).trigger("resize")
}catch(l){}}$(".textarea-bg-text").html("")},clearOutput:function(){s.clearOutputWrap(),d.destroyNav(),this.setEmptyHash()
},clearAll:function(t){s.clearOutputWrap(),this.clearInput(t),d.destroyNav(),this.setEmptyHash(),l.sendIndexBannerLog({source:"clear"})
},showIcon:function(){this.clearBtn.show()},hideIcon:function(){this.clearBtn.hide()},getElem:function(){return this.clearBtn
},setEmptyHash:function(){o.setHash({query:""})}};n.clearOutput=function(){h.clearOutput()},n.clearAll=function(t){h.clearAll(t)
},n.clearInputAndOutput=function(){h.clearInput(),s.clearOutputWrap()},n.show=function(){h.showIcon()},n.hide=function(){h.hideIcon()
},n.getElem=function(){return h.getElem()}});
...
;define("translation:widget/translate/translang/tolang",function(t,n){"use strict";var a=(t("translation:widget/common/third_party/template"),t("translation:widget/common/environment"),t("translation:widget/translate/translang/transbtn")),e=t("translation:widget/translate/translang/manualTrans"),o=t("translation:widget/common/config/langMap"),l=t("translation:widget/translate/translang/langPanelContainer.jsx"),r={hideToWrap:function(){l.hideToWrap()
},tolangChange:function(t){var n=t.lang,a=this;a.tolangItemSelect({value:n,trans:t.trans})},tolangItemSelect:function(t){var n=t.value,r=o[n].zhName;
$(".select-to-language .language-selected").attr("data-lang",n).text(r),l.changeTo(n),this.hideToWrap(),t.trans&&a.doTrans(),e.updateManualTransBtn(),$("body").trigger("updateFromTo.domainTrans")
}};n.toBtnClicked=function(){r.toBtnClicked()},n.tolangChange=function(t){r.tolangChange(t)},n.tolangItemSelect=function(t){r.tolangItemSelect(t)
},n.hideToWrap=function(t){r.hideToWrap(t)}});
...
},function(t){r("throw",t)})}return r("next")})}}function a(t){return 20>Q-t?3e3:1e4}function o(){var t=T.currTask,n=t.from,e=t.to,r=t.fileName;
b.find(".file-name").text(r);var a="auto"===n&&"auto"===e;b.find(".doc-view-from-lang").text(a?"中英互译":y[n].zhName),b.find(".doc-view-to-lang").text(a?"":y[e].zhName),b.find(".doc-view-lang-pair").toggleClass("auto",a),_.show(),C.hide(),b.addClass("loading"),S=null
...
E.text(e.title),O.text(e.content),_.hide(),C.show(),q.hide()}}function d(t){var n=t.isHtml,e=t.data,r=t.isOriginalOverflow;
if(n){G.text(T.currTask.fileName);var a=e.style,o=e.html,i=document.createElement("style");i.type="text/css",i.innerHTML=a,i.id="doc-specified-style",document.head.appendChild(i),H.html(o),R.html(o),H.find(".translated-span").each(function(t,n){var e=$(n);
e.text(e.attr("data-src-str"))}),S=$(".doc-whole-container .translated-span"),l(),r&&m(),window._hmt.push(["_trackEvent","首页","文档翻译_结果页展现，成功展示原文译文对照"]),h()
}else J.attr("src","https://view.officeapps.live.com/op/embed.aspx?src="+T.currTask.url)}function l(){$("#doc-fill-div").remove();
var t=H.height(),n=R.height(),e=Math.abs(t-n),r=n>t?H:R,a=$('<div style="height: '+e+'px" id="doc-fill-div"></div>');r.append(a)
}function u(t){t.stopPropagation(),U.hasClass("generating")||(T.currTask.isHtml&&T.currTask.isOriginalOverflow&&!localStorage.getItem("doNotTipExportOverflow")?(window._hmt.push(["_trackEvent","首页","77_首页页面_导出提示展示"]),F.show()):k())
...
if(Array.isArray(e)){var r=w(e,5),a=r[1],i=r[2],s=r[3],l=r[4];Object.assign(T.currTask,{fileName:a,from:i,to:s,token:l}),o(),T.clearDocTransMode(),$("#main-outer").addClass("doc-trans-view-mode"),$(".footer").hide(),nn.uploadSuccess(),g().then(function(t){var n=t.isHtml,e=t.data;
...
Object.assign(T.currTask,{url:c})}Object.assign(T.currTask,{isHtml:n}),_.removeAttr("style"),C.removeAttr("style"),b.removeClass("loading").addClass("viewing-"+(n?"html":"file")),d({isHtml:n,data:e,isOriginalOverflow:r}),n&&(tn=!0,P.scrollTop(0))
}},c)}}function h(){setTimeout(function(){B=A.offset().top,K=A.height()},100)}function m(){[H,R].forEach(function(t){var n=t.find(".last-translated-sen"),e=n.offset().left-t.offset().left;
...
return regeneratorRuntime.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:t=Q;case 1:if(!(t>0)){n.next=23;break}return e=a(t),n.next=5,i(e);
case 5:if($("#main-outer").hasClass("doc-trans-view-mode")){n.next=7;break}return n.abrupt("break",23);case 7:return n.next=9,s();
case 9:if(r=n.sent,0!==r.errno){n.next=19;break}return nn.complete(),n.next=14,i(600);case 14:return o=!0,"string"!=typeof r.data&&(o=!1),n.abrupt("return",{isHtml:o,data:o?JSON.parse(r.data):r.data.url});
case 19:t-=e/1e3,nn.add();case 21:n.next=1;break;case 23:throw{content:"非常抱歉，文档解析超时"};case 24:case"end":return n.stop()}},n,this)
}));return function(){return t.apply(this,arguments)}}(),k=function(){var t=r(regeneratorRuntime.mark(function n(){var t;
return regeneratorRuntime.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:if(window._hmt.push(["_trackEvent","首页","82_首页页面_开始导出"]),!U.prop("data-has-gen-link")){n.next=6;
...
break;case 6:U.addClass("generating");case 7:if(!$("#main-outer").hasClass("doc-trans-view-mode")){n.next=22;break}return n.next=10,f();
case 10:if(t=n.sent,0!==t){n.next=18;break}return U.removeClass("generating").prop("data-has-gen-link",!0),window.location.href="https://fanyi-doc.baidu.com/doctrans/download?fileToken="+T.currTask.token,window._hmt.push(["_trackEvent","首页","83_首页页面_成功导出"]),n.abrupt("return");
case 18:return n.next=20,i(X);case 20:n.next=7;break;case 22:case"end":return n.stop()}},n,this)}));return function(){return t.apply(this,arguments)
}}();t("translation:widget/common/third_party/jquery_scrollbar/jquery_scrollbar");var T=t("translation:widget/translate/docTranslate/docTransUtil"),x=t("translation:widget/translate/input/uploader"),y=t("translation:widget/common/config/langMap"),b=$(".doc-trans-view-wrap"),_=b.find(".loading-container"),C=b.find(".loading-err-container"),E=b.find(".err-title"),O=b.find(".err-content"),S=null,j=b.find(".doc-whole-container"),P=b.find(".src-doc-scroll-wrapper,.dst-doc-scroll-wrapper"),A=b.find(".src-doc-scroll-wrapper"),I=b.find(".dst-doc-scroll-wrapper"),H=b.find(".src-doc-padding-wrapper"),R=b.find(".dst-doc-padding-wrapper"),q=b.find(".loading-exit-btn"),N=b.find(".err-exit-btn"),M=b.find(".err-re-upload-btn"),D=b.find(".view-re-upload-btn"),U=b.find(".export-doc-btn"),F=b.find(".export-tip"),z=b.find(".no-tip-check"),L=b.find(".confirm-export-btn"),G=b.find(".view-file-name"),J=$("#doc-view-iframe"),V=b.find(".doc-async-translating-tip"),W=b.find(".go-back"),B=0,K=0,Q=window.common.domainHit?240:120,X=5e3,Y=2,Z=4,tn=!1;
$.fn.scrollEnd=function(t){var n=500;$(this).scroll(function(e){var r=$(this);return r.is(A)&&tn?void(tn=!1):(r.data("scrollTimeout")&&clearTimeout(r.data("scrollTimeout")),void r.data("scrollTimeout",setTimeout(function(){t(e),r.data("scrollTimeout",0)
},n)))})};var nn=T.progress;!function(){x.on("uploadSuccess",function(t,n){if(0===n.errno){var e=n.fileToken,r=T.currTask.file.name,a=T.currTask,o=a.from,i=a.to;
...
}),x.on("uploadError",function(){c({content:"网络不给力，请稍后重试"})}),q.add(N).on("click",function(t){$(t.currentTarget).is(q)?window._hmt.push(["_trackEvent","首页","文档翻译_loading点击退出按钮"]):$(t.currentTarget).is(N)&&window._hmt.push(["_trackEvent","首页","文档翻译_文档解析失败点击退出按钮"]),location.hash="",T.clearDocTrans(!1)
}),M.add(D).on("click",function(t){$(t.currentTarget).is(D)?window._hmt.push(["_trackEvent","首页","76_首页页面_点击上传新文档按钮"]):$(t.currentTarget).is(M)&&window._hmt.push(["_trackEvent","首页","文档翻译_文档解析失败点击重新上传"]),location.hash="",T.clearDocTrans(!0)
}),U.on("click",u),F.on("click",function(t){return t.stopPropagation()}),z.on("click",function(){z.hasClass("checked")||window._hmt.push(["_trackEvent","首页","78_首页页面_选中导出提示中不再提示复选框"]),z.toggleClass("checked")
}),L.on("click",function(){window._hmt.push(["_trackEvent","首页","79_首页页面_点击导出提示中确认导出"]),z.hasClass("checked")&&localStorage.setItem("doNotTipExportOverflow","true"),F.hide(),k()
}),$(window).on("click",function(){"none"!==F.css("display")&&F.hide()}),W.on("click",function(){location.href=T.currTask.file?"/#/docTransMode":"/"
}),j.on("mouseenter","span.translated-span",function(t){var n=$(t.currentTarget),e=n.attr("data-span-idx"),r=null,a=null,o=null;
A.find(n).length>0?(r=A,a=I):(r=I,a=A),o=a.find(".translated-span[data-span-idx='"+e+"']"),n.add(o).addClass("hover");var i=B,s=i+a.height(),c=o.offset().top,d=c+o.height(),l=d-s;
if(l>0)a.is(A)&&(tn=!0),a.scrollTop(a.scrollTop()+l);else{var u=i-c;u>0&&(a.is(A)&&(tn=!0),a.scrollTop(a.scrollTop()-u))}}),j.on("mouseleave","span.translated-span",function(){S.removeClass("hover")
}),A.scrollbar(),I.scrollbar(),P.on("scroll",function(t){if(0!==S.length){var n=$(t.currentTarget);if(n.is(":hover")){var e=n.hasClass("src-doc-scroll-wrapper")?I:A,r=0,a=-1,o=n.find(".translated-span, .not-translated-para"),i=B,s=null,c=!0,d=0;
do{var l=o.eq(d++),u=l.offset().top-i;u>0&&(s=l,s.is(".not-translated-para")&&(c=!1),r=u,a=l.attr(c?"data-span-idx":"data-para-idx"))
}while(null===s&&d<o.length);if(-1!==a){var f=e.find("["+(c?"data-span-idx":"data-para-idx")+"='"+a+"']"),p=B+r-f.offset().top;
e.scrollTop(e.scrollTop()-p)}}}});A.height();A.scrollEnd(function(){function t(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:!1,e=t.text(),s=t.attr("data-para-idx");
r.push(t),a.push(e),n&&T.currTask.translatingParaIdxSet.add(s),o.push(s),i+=v(e)+1}if($("#main-outer").hasClass("doc-trans-view-mode")&&T.currTask.isOverflow){var n=A.find(".not-translated-para"),e=null,r=[],a=[],o=[],i=0,s=0,c=null,d=!1,u=0;
do{c=n.eq(s++);var f=c.offset().top,p=f+c.height(),h=p-B;u=f-B,d=u>=K*Z,T.currTask.translatingParaIdxSet.has(c.attr("data-para-idx"))||d||(h>0?e=c:u>-(K*Y)&&t(c,!1))
}while(null===e&&s<n.length&&!d);if(null!==e){var m=function(){o.forEach(function(t){T.currTask.translatingParaIdxSet.delete(t)
})};for(K>u&&V.show(),o.forEach(function(t){return T.currTask.translatingParaIdxSet.add(t)}),s-=1;s<n.length;s++){var w=n.eq(s);
if(t(w,!0),i>3e4)break}var g=a.join("\n"),k=Date.now().toString(),x=T.currTask,y=x.detectedFrom,b=x.detectedTo;$.ajax({url:"https://fanyi-doc.baidu.com/doctrans/api/multitrans",type:"POST",dataType:"json",data:{from:y,to:b,query:g,timeStamp:k},success:function(t){if($("#main-outer").hasClass("doc-trans-view-mode")){if(m(),0!==t.errno)return void V.hide();
...
});for(var e=a.length-n.length,i=0;e>i;i++)n.push(null);r.forEach(function(t,e){var r=I.find("[data-para-idx='"+o[e]+"']"),a=n[e],i=t.add(r);
...
if(r.attr("data-span-idx",a),n<s.length-1){var o=d.clone(),i=l.clone();d.after(o),l.after(i),d=o,l=i}})}}),l(),0===A.find(".not-translated-para").length&&(T.currTask.isOverflow=!1),S=j.find(".translated-span"),V.hide()
}},error:function(){m(),V.hide()}})}}}),$(window).on("resize.adjustDocHeight",function(){$("#main-outer").hasClass("doc-trans-view-mode")&&b.hasClass("viewing-html")&&(l(),h())
...
return new Promise(function(t,e){function a(o,i){try{var r=n[o](i),s=r.value}catch(l){return void e(l)}return r.done?void t(s):Promise.resolve(s).then(function(t){a("next",t)
},function(t){a("throw",t)})}return a("next")})}}function a(){A=!0}function o(t){A=!1,i(t)}function i(t){l(t),A||g.onRtTrans(t),D.updateManualTransBtn()
}function r(t){t.stopPropagation(),(!E.pasteCompatibility||E.handle(t))&&(g.onRtTrans(t,"paste"),T.switchFontSize())}function s(t){C.onTextAreaKeyDown(t)
}function l(t){var n=$("#baidu_translate_input").val(),e=y[0];if(!("input"!==t.type&&("oninput"in e&&(!P||"keyup"!==t.type||8!==t.which&&46!==t.which)||"keyup"!==t.type||38===t.which||40===t.which||C.getCloseSugByEnter()||13===t.which&&C.getTranslatedByKeyDown()))){var a=T.switchFontSize();
a||t.triggerByOcr||A?C.clearAndHideSug():_.getByte(n)<=24&&C.loadSug()}if(S.hideWrap(),v.onHistoryInput(),b.onAdLinkInput(),n){if(13===t.which)return C.getCloseSugByEnter()&&C.setCloseSugByEnter(!1),void(C.getTranslatedByKeyDown()?C.setTranslatedByKeyDown(!1):m.onTranslate({transtype:"enter"}));
c.hasQuery(n),B.get("shouldClearPromptOnInput")&&(h.hide(),B.set("shouldClearPromptOnInput",!1))}else k.translateStopRepeat()||k.shutdownAudio(),f.clearAll(!1)
}var c=t("translation:widget/translate/input/textarea"),u=t("translation:widget/translate/input/soundicon"),d=t("translation:widget/translate/input/sound"),p=t("translation:widget/translate/input/correct"),g=t("translation:widget/translate/input/rttrans"),h=t("translation:widget/translate/input/prompt"),m=t("translation:widget/translate/input/translate"),w=t("translation:widget/translate/input/inputSoungUrlHandler"),f=t("translation:widget/translate/input/clear"),v=t("translation:widget/translate/history/history"),y=c.getElem(),k=t("translation:widget/translate/details/dictionary/simplemeans"),T=t("translation:widget/translate/input/fontSize"),C=t("translation:widget/translate/input/inputSug"),_=t("translation:widget/common/string"),S=t("translation:widget/translate/zonedword/wordWrap"),b=t("translation:widget/translate/details/adLink/adLink"),E=t("translation:widget/translate/input/dataTransfer"),x=t("translation:widget/translate/input/drag"),D=t("translation:widget/translate/translang/manualTrans"),B=t("translation:widget/common/environment"),R=t("translation:widget/translate/input/uploader"),I=t("translation:widget/translate/docTranslate/docTransUtil"),L=t("translation:widget/login/login"),z=t("translation:widget/translate/domain/domain"),P="oninput"in y[0]&&"documentMode"in document&&9===document.documentMode,A=!1;
n.onClearBtnClick=function(){return $("#main-outer").hasClass("doc-trans-mode")?(window._hmt.push(["_trackEvent","首页","文档翻译_上传后点x删除文档"]),void(location.href="/")):(k.translateStopRepeat()||k.shutdownAudio(),f.clearAll(),T.switchFontSize(),C.clearAndHideSug(),void D.updateManualTransBtn())
},n.init=function(){function n(t){var n=E.pasteCompatibility||E.dragCompatibility;I.logWrongFileFormat(t),alert("目前仅支持 "+(window.common.pdfHit?"pdf、":"")+"docx、doc、ppt、pptx、xls、xlsx"+(n?"、jpg、png、bmp、jpeg ":" ")+"格式哦")
}var l=this,g=this;y.on("compositionstart",a).on("compositionend",o).on("input",i).on("keyup",i).on("paste",r).on("keydown",s),$(document).on("paste",function(t){E.pasteCompatibility&&E.handle(t)
}),f.getElem().on("click",function(t){t.preventDefault(),g.onClearBtnClick(),_hmt.push(["_trackEvent","首页","web端点击清空输入框"])
}),u.getElem().on("click",function(t){t.preventDefault(),k.judgeStopRepeat(),g.timer&&clearTimeout(g.timer);var n=w.getInputSoundUrl();
d.makeSound(this,n),_hmt.push(["_trackEvent","首页","web端原文发音TTS"]),_hmt.push(["_trackEvent","首页","web端点击发音按钮"])}),u.getElem().on("mouseover",function(){if("hover"===B.get("soundTriggerMode")){var t=$(this);
g.timer=setTimeout(function(){k.judgeStopRepeat();var n=w.getInputSoundUrl();d.makeSound(t,n),_hmt.push(["_trackEvent","首页","web端原文发音TTS"]),_hmt.push(["_trackEvent","首页","web端点击发音按钮"])
},500)}}),u.getElem().on("mouseout",function(){g.timer&&clearTimeout(g.timer)}),$(".trans-correct").on("click",".correct-query",function(t){t.preventDefault();
var n=$(this).text();p.onCorrect(n),_hmt.push(["_trackEvent","首页","web端query纠错点击次数"])}),$(".trans-prompt").on("click",".source-lang",function(t){t.preventDefault();
var n=$(this).attr("data-lang");h.onPrompt(n),_hmt.push(["_trackEvent","首页","web端点击语种检测提示"])}).on("click",".open-from-lang",function(n){n.stopPropagation();
var e=t("translation:widget/translate/translang/langPanelContainer.jsx");e.fromBtnClicked()}),$(".trans-input-wrap").on("click",".input-wrap",function(t){var n=$(t.target);
(n.hasClass("input-wrap")||n.hasClass("textarea-wrap"))&&(t.preventDefault(),c.focus())}),x.bindEvent();var m=$("#image-holder"),v=$("#preview-img"),T=$(".translateio");
m.on("click",function(){if(v.is(":hidden")){var t=v.get(0),n=window.URL||window.webkitURL;t.onload=function(){var t=this.src;
setTimeout(function(){n.revokeObjectURL(t)},1e3),T.addClass("is-zoom-in");try{$(window).trigger("resize")}catch(e){}},t.src=n.createObjectURL(m.data("file")),_hmt.push(["_trackEvent","首页","56_首页页面_点击放大缩略图的次数"])
}else{T.removeClass("is-zoom-in");try{$(window).trigger("resize")}catch(e){}}}),v.on("click",function(){T.removeClass("is-zoom-in");
...
}catch(n){}if("/docTransMode"===e)I.currTask.file?($(".doc-trans-file").text(I.currTask.file.name),I.clearDocTransViewMode(),$("#main-outer").addClass("doc-trans-mode"),z.hide(),localStorage.getItem("docTransLangGuideFlag")||($(".doc-trans-operation").addClass("guiding"),$(".doc-trans-operation .doc-trans-dir").addClass("open"))):I.clearDocTrans();
else if(I.viewModeRegExp.test(e)){var a=t("translation:widget/translate/docTranslate/docTranslate");a.onHashChange()}else I.clearDocTrans(),t("translation:widget/translate/input/autoRequest").onHashChange()
}),R.on("fileQueued",function(){var t=e(regeneratorRuntime.mark(function a(t){var e;return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:if(!I.isSupportByDocTrans(t)){a.next=16;
break}if(window.common.docTransWithoutLogin){a.next=4;break}return a.next=4,L.ensureUserLoginAsync();case 4:if(e=10,!(t.size>1024*e*1024)){a.next=10;
break}return R.removeFile(t,!0),window._hmt.push(["_trackEvent","首页","文档翻译_提示大小超限"]),alert("文档大小目前仅支持 "+e+"M 以内，建议拆分文档重试哦"),a.abrupt("return");
case 10:f.clearAll(),I.currTask.file=t,I.currTask.fileName=t.name,location.hash="/docTransMode",a.next=18;break;case 16:t.type.startsWith("image/")&&(E.pasteCompatibility||E.dragCompatibility)?E.processImgFile(t.getSource().source):n(t),R.removeFile(t,!0);
case 18:case"end":return a.stop()}},a,l)}));return function(){return t.apply(this,arguments)}}()),R.on("error",function(t,e){"Q_TYPE_DENIED"===t&&n(e)
}),$("#upload-btn").on("click",function(){Boolean(B.get("account").is_login)||window.common.docTransWithoutLogin?$("#upload-btn-hidden").find('input[type="file"]').click():L.newLoginInstanceAsync(),_hmt.push(["_trackEvent","首页","75_首页页面_点击上传文档按钮"])
});var C=localStorage.getItem("hasShowDocTip");C||($("#upload-btn").addClass("with-first-tip"),$(window).on("click.hideDocTip",function(){$("#upload-btn").removeClass("with-first-tip"),$(window).off("click.hideDocTip"),localStorage.setItem("hasShowDocTip","true")
})),$(window).on("click.stopSound",function(t){var n=$(t.target);n.hasClass("icon-sound")||n.hasClass("op-sound")||n.hasClass("sound-btn")||n.hasClass("icon-repeat")||n.hasClass("op-repeat")||(BTPM.doPause(),k.shutdownRepeat(),$(".op-sound").removeClass("op-sound-active"))
});var _=[32,13];$(document).on("keypress",function(n){if(!y.is(":focus")&&!(y.val().trim().length>0||_.includes(n.which)||n.altKey||n.ctrlKey||n.metaKey)){var e=$("#main-outer");
if(!e.hasClass("doc-trans-mode")&&!e.hasClass("doc-trans-view-mode")){var a=document.getElementById("passport-login-pop");
if(!a||"none"===a.style.display){var o=t("translation:widget/translate/translang/langPanelContainer.jsx");0===o.getCurrLangType()&&y.focus()
}}}})};n.textareaInput=l});
...
break}}else if(E.isSupportByDocTrans(f)&&window.common.docHit){if(f){s=!0,u=f;break}}else if("drop"===e&&window.common.docHit&&!E.isUrlFileInEdge(f)){E.logWrongFileFormat(f),alert("目前仅支持 "+(window.common.pdfHit?"pdf、":"")+"docx、doc、ppt、pptx、xls、xlsx、jpg、png、bmp、jpeg 格式哦");
break}}}}else for(var g=a.length-1;g>=0;g--){var v=a.item(g);if(v.type.startsWith("image/")){i=!0,o=v;break}if(E.isSupportByDocTrans(v)&&window.common.docHit){s=!0,u=v;
break}if("drop"===e&&window.common.docHit&&!E.isUrlFileInEdge(v)){E.logWrongFileFormat(v),alert("目前仅支持 "+(window.common.pdfHit?"pdf、":"")+"docx、doc、ppt、pptx、xls、xlsx、jpg、png、bmp、jpeg 格式哦");
...
}else if(s)return t.preventDefault(),"drop"===e&&window._hmt.push(["_trackEvent","首页","文档翻译_拖入上传"]),b.addFiles(u),!1;return!0
}function i(t){var e=window.URL||window.webkitURL,n=e.createObjectURL(t);C.css("background-image","url('"+n+"')"),C.data("file",t);
var r=new Image;r.onload=function(){var t=this.src;setTimeout(function(){e.revokeObjectURL(t)},1e3)},r.src=n}function o(t){return j.compress(t,{maxWidth:1280,maxHeight:1280,convertSize:3e6}).catch(function(){return g(!1),Promise.reject()
...
}function l(t){return t>=15&&4096>=t}function d(t){return D.includes(t)||"auto"===t?!0:(alert("当前语言不支持图片识别，请选择语言"),y.fromBtnClicked(),!1)
}function p(e,n){if(L.removeClass("with-loading-ocr-tip"),0!==e.errno||0===e.errno&&0===e.data.src.length){t("translation:widget/translate/input/clear").show(),w.set("shouldClearPromptOnInput",!0);
...
}else{var a=e.data.src.join(""),i=e.data.from,o=v.getElem();o.val(a),w.set("isProcessOcrResult",!0);var s=t("translation:widget/translate/input/events");
...
}}function m(){C.css("background-image","none"),L.removeClass("with-image"),C.data("file",null)}function f(){return $(".trans-input-wrap").hasClass("with-image")&&$("#image-holder").data("file")&&!$("#baidu_translate_input").val()?(h($("#image-holder").data("file"),!0),!1):!0
}function g(t){L.toggleClass("with-loading-ocr-tip",t),$("body").toggleClass("no-interaction",t),U=t}function _(t){for(var e=[],n=0;n<t.length;n++)e.push({kind:t[n].kind,type:t[n].type});
...
}return n.abrupt("return");case 13:return n.next=15,o(e);case 15:e=n.sent;case 16:return n.next=18,s(e,c,l);case 18:f=n.sent,r||(i(e),L.addClass("with-image")),p(f,c),g(!1);
case 22:case"end":return n.stop()}},n,this)}));return function(){return e.apply(this,arguments)}}(),v=t("translation:widget/translate/input/textarea"),w=t("translation:widget/common/environment"),k=t("translation:widget/common/third_party/image-compressor"),x=t("translation:widget/common/third_party/bowser"),b=t("translation:widget/translate/input/uploader"),E=t("translation:widget/translate/docTranslate/docTransUtil"),y=t("translation:widget/translate/translang/langPanelContainer.jsx"),j=new k,L=$(".trans-input-wrap"),C=$("#image-holder"),R=!1,I=!1,T=0,U=!1,F=10,O=1048576*F,P=3,H=1e3*P,D=w.get("ocrLangList"),B=["png","jpg","bmp","jpeg"];
!function(){if("1"===window.common.ocrHit){var t=window.URL||window.webkitURL;t&&"function"==typeof t.createObjectURL&&!x.msie&&!x.ucbrowser&&window.FormData&&"undefined"!=typeof window.FileReader&&("draggable"in document.createElement("span")&&(I=!0),x.check({firefox:"41",chrome:"13",opera:"12.1"},!0)&&(R=!0))
}}();var S=L.find(".textarea-bg .prompt-text");window.common.docHit?R?(S.text("输入文字、网址 / 粘贴图片 / 拖入文档"),_hmt.push(["_trackEvent","首页","54_首页页面_输入框默认文案_输入文字、网址 / 粘贴图片 / 拖入文档"])):I?(S.text("输入文字、网址 / 拖入图片、文档"),_hmt.push(["_trackEvent","首页","54_首页页面_输入框默认文案_输入文字、网址 / 拖入图片、文档"])):(S.text("输入文字、网址"),_hmt.push(["_trackEvent","首页","54_首页页面_输入框默认文案_输入文字、网址"])):R?(S.text("输入文字、网址或粘贴图片 即可翻译"),_hmt.push(["_trackEvent","首页","54_首页页面_输入框默认文案_输入文字、网址或粘贴图片 即可翻译"])):I?(S.text("输入文字、网址或拖拽图片 即可翻译"),_hmt.push(["_trackEvent","首页","54_首页页面_输入框默认文案_输入文字、网址或拖拽图片 即可翻译"])):(S.text("输入文字或网址 即可翻译"),_hmt.push(["_trackEvent","首页","54_首页页面_输入框默认文案_输入文字、网址 即可翻译"])),n.exports={handle:a,pasteCompatibility:R,dragCompatibility:I,clearInputImage:m,checkAndTranslateThumbnail:f,processImgFile:h}
});
...
;define("translation:widget/translate/translang/fromlang",function(a,t){"use strict";var e=a("translation:widget/common/environment"),n=a("translation:widget/translate/translang/transbtn"),r=a("translation:widget/translate/input/dir"),l=a("translation:widget/translate/translang/tolang"),s=a("translation:widget/translate/translang/manualTrans"),o=a("translation:widget/common/config/langMap"),g=a("translation:widget/translate/translang/langPanelContainer.jsx"),i={hideFromWrap:function(){g.hideFromWrap()
},fromlangChange:function(a){var t=a.lang,e=this;e.fromlangItemSelect({value:t,trans:a.trans,isDetected:a.isDetected})},fromlangItemSelect:function(t){var e=t.value,i=o[e].zhName;
t.isDetected&&(i="检测到<span>"+i+"</span>"),$(".select-from-language .language-selected").attr({"data-lang":e,"data-detected":t.isDetected?"1":"0"}).attr("data-lang",e).html(i),"auto"===e?this.autoItemSelected({isDetected:t.isDetected}):this.normalItemSelected({isDetected:t.isDetected}),r.changeDir(e),g.changeFrom(e),this.hideFromWrap();
var d=$(".select-to-language .language-selected").attr("data-lang");if(e===d){var c="en"===e?"zh":"en";l.tolangChange({lang:c})
}if(t.trans){var m=a("translation:widget/translate/input/dataTransfer");m.checkAndTranslateThumbnail()&&n.doTrans()}s.updateManualTransBtn(),$("body").trigger("updateFromTo.domainTrans")
},autoItemSelected:function(a){a.isDetected||e.set("fromLangIsAuto",!0),$(".from-to-exchange .exchange-mask").css({"background-position":"-2px 50%"});
var t=$(".from-to-exchange");t.hasClass("language-btn")&&t.removeClass("language-btn").addClass("language-btn-disable"),t.attr("aflag",0)
},normalItemSelected:function(a){a.isDetected||e.set("fromLangIsAuto",!1);var t=$(".from-to-exchange");t.hasClass("language-btn-disable")&&t.removeClass("language-btn-disable").addClass("language-btn")
}};t.fromBtnClicked=function(){i.fromBtnClicked()},t.hideFromWrap=function(){i.hideFromWrap()},t.fromlangChange=function(a){i.fromlangChange(a)
},t.fromlangItemSelect=function(a){i.fromlangItemSelect(a)}});
;define("translation:widget/translate/input/prompt",function(t,n){"use strict";var r=t("translation:widget/common/environment"),o=t("translation:widget/translate/translang/fromlang"),a=t("translation:widget/common/third_party/template"),e=t("translation:widget/translate/history/history"),p=t("translation:widget/translate/details/adLink/adLink"),s=t("translation:widget/common/config/langMap"),i={hidePrompt:function(){$(".trans-prompt").hide()
},showPrompt:function(t,n){var a=s.hasOwnProperty(t),e="1"===$(".select-from-language .language-selected").attr("data-detected");
return r.get("fromLangIsAuto")&&a?(o.fromlangChange({lang:t,isDetected:!0}),void this.hidePrompt()):void($(".trans-correct").is(":hidden")&&("LAN-UNKNOWN"!==t||"auto"!==n&&!e?n===t||!a||"wyw"===n&&"zh"===t?this.hidePrompt():this.renderPrompt(t,!1):this.renderUndetectedPrompt()))
},renderUndetectedPrompt:function(){$(".trans-prompt .prompt-wrap").html('<span class="prompt-text prompt-text-left-align">检测失败，请手动选择语言</span>').parent().show(),$(".operate-btn.op-sound").hide(),$(".operate-btn.op-favo").hide()
},renderPrompt:function(t,n){var r=s[t].zhName,o=a("tplLangPrompt",{lang:t,langText:r,isOcr:n});$(".trans-prompt .prompt-wrap").html(o).parent().show(),this.sendShowPromptLog()
...
},showCustomPrompt:function(t,n,r){var o='<span dir="ltr">';o+='<span class="prompt-text" style="margin-left: -42px;">'+t+"</span>",n&&(o+='<a href="javascript:" class="prompt-link'+(r?" "+r:"")+'">'+n+"</a>"),o+="</span>",$(".trans-prompt .prompt-wrap").html(o).parent().show(),e.onHistoryInput(),p.onAdLinkInput()
}};n.hide=function(){i.hidePrompt()},n.show=function(){i.showPrompt.apply(i,arguments)},n.onPrompt=function(t){i.onPrompt(t)
},n.renderPrompt=function(){i.renderPrompt.apply(i,arguments)},n.showCustomPrompt=function(){i.showCustomPrompt.apply(i,arguments)
}});
...
$(".select-inner").stop(!0,!0),n.has("span").length>0&&(t=n.find("span").text()),n.text(c).attr({"data-lang":i,"data-detected":"0"}),s.text(t).attr("data-lang",e),$(".select-inner").css({left:0}),g.fromlangChange({lang:i}),l.tolangChange({lang:e,trans:!a})
...
;define("translation:widget/translate/input/processlang",function(n,t,e){"use strict";function a(n,t,e){return g.set("detectLang",n),g.get("fromLangIsAuto")?(t=n,e=$(".select-to-language .language-selected").attr("data-lang")):n!==e||g.get("langChangedByUser")||("zh"===e&&$.inArray(t,c)>=0?(o.execExchange(!0),e=t,t=n,$(".trans-prompt").hide()):"zh"===t&&$.inArray(e,c)>=0&&(o.execExchange(!0),e=t,t=n,$(".trans-prompt").hide())),g.set("langChangedByUser",!1),{fromLang:t,toLang:e}
}function r(n,t,e){return l.includes(t)&&l.includes(e)&&n===e?(o.execExchange(!0),e=t,t=n,$(".trans-prompt").hide()):p.includes(t)&&"en"===e||!i.hasOwnProperty(n)||s.renderPrompt(n,!0),{fromLang:t,toLang:e}
}var g=n("translation:widget/common/environment"),o=n("translation:widget/translate/translang/exchange"),s=n("translation:widget/translate/input/prompt"),i=n("translation:widget/common/config/langMap"),c=["ara","de","en","spa","it","fra","pt","ru","th","kor"],l=["zh","en","jp","kor"],p=["de","spa","it","fra","pt"];
...
;define("translation:widget/translate/input/translate",function(t,a){"use strict";var e=t("translation:widget/translate/input/prompt"),n=t("translation:widget/translate/input/textarea"),r=t("translation:widget/common/util"),o=t("translation:widget/translate/output/output"),s=t("translation:widget/common/config/trans"),i=t("translation:widget/translate/input/processlang"),l=t("translation:widget/common/string"),u=t("translation:widget/translate/input/soundicon"),g=t("translation:widget/translate/input/hash"),d=t("translation:widget/common/environment"),c=t("translation:widget/translate/input/longtext"),p=t("translation:widget/common/sendLog"),m=t("translation:widget/translate/details/dictionary/simplemeans"),f=t("translation:widget/translate/history/history"),y=t("translation:widget/translate/input/pGrab"),h=t("translation:widget/translate/details/adLink/adLink"),w=t("translation:widget/translate/domain/domain"),v={onTrans:function(t){m.translateStopRepeat()||m.shutdownAudio();
var a=(n.getElem(),n.getVal()),e=this,o=t&&t.transtype;if(r.isUrl(a))return void this.translateWebPage(a);if(a.length>0&&p.sendIndexDisplayLog({action:"query"}),this.isQueryValid(a)){var s=a;
s.length>50&&(s=l.cutByByte(s,0,150).replace(/[\uD800-\uDBFF]$/,""));var i={query:s};$.ajax({url:"/langdetect",type:"POST",data:i,success:function(t){0===t.error&&t.lan?e.langIsDeteced(t.lan,a,o):e.reponseQuery(a)
}})}},isQueryValid:function(t){return t?!0:!1},processQuery:function(t){var a=t;if(l.getByte(t)>s.MAX_QUERY_COUNT){d.set("needLongtextTip",!0);
var e=t;a=l.cutByByte(t,0,s.MAX_QUERY_COUNT).replace(/[\uD800-\uDBFF]$/,""),e=l.cutByByte(e,s.MAX_QUERY_COUNT,s.MAX_QUERY_COUNT+9),c.showTip({query:e})
}return a},langIsDeteced:function(a,n,r,o){if(null!==a){var s=$(".select-from-language .language-selected").attr("data-lang"),l=$(".select-to-language .language-selected").attr("data-lang"),g="1"===$(".select-from-language .language-selected").attr("data-detected"),c=!1;
d.get("langChangedByUser")&&a===l&&(c=!0);var p=null;if(o&&!d.get("fromLangIsAuto")&&s!==a?p=i.processOcrLang(a,s,l):(e.show(a,s),p=i.getLang(a,s,l)),"LAN-UNKNOWN"===a&&("auto"===s||g)){var m=t("translation:widget/translate/input/clear");
return void m.clearOutput()}u.show(),$("body").trigger("updateFromTo.domainTrans",p);var f=this,n=this.processQuery(n),h={from:p.fromLang,to:p.toLang,query:n,transtype:r,simple_means_flag:3,sign:y(n),token:window.common.token,domain:w.getCurDomain()};
w.log(),this.translateXHR&&4!==this.translateXHR.readyState&&this.translateXHR.abort(),this.translateXHR=$.ajax({type:"POST",url:"/v2transapi?from="+encodeURIComponent(p.fromLang)+"&to="+encodeURIComponent(p.toLang),cache:!1,data:h}).done(function(t){d.set("isInRtTransState",!0),f.translateSuccess(t,p.fromLang,p.toLang,n,c)
...
},textareaFocus:function(){n.focus()},translateSuccess:function(t,a,e,r,s){return n.getVal()?(r&&f.add(a,e,$.trim(r)),f.hideHistory(),h.hide(),o.checkResponse({res:t,from:a,to:e,query:r,badCaseByForce:s}),void g.setHash({query:r})):void d.set("isInRtTransState",!1)
},reponseQuery:function(){}};a.onTranslate=function(t){v.onTrans(t)},a.translateAfterOcr=function(t,a){_hmt.push(["_trackEvent","首页","59_首页页面_翻译query量_图片"]),v.langIsDeteced(t,a,void 0,!0)
}});
;define("translation:widget/translate/domain/domain",function(a,n,t){"use strict";function o(a,n,t){return n in a?Object.defineProperty(a,n,{value:t,enumerable:!0,configurable:!0,writable:!0}):a[n]=t,a
}function e(){w.find(".domain-trans-toast-text").text("已切换到"+M[C]+(C===h.COMMON?"":"领域")),$("body").append(w),null!=O&&clearTimeout(O),O=setTimeout(function(){return i()
},2e3)}function i(){w.remove().find(".domain-trans-toast-text").text(""),null!=O&&(clearTimeout(O),O=null)}function d(){window._hmt.push(["_trackEvent","首页","99_首页页面_"+M[C]+"领域发起翻译次数"])
}function r(){return C}function s(a){var n=a.domain,t=a.fromLang,o=a.toLang;switch(n){case h.COMMON:return!1;case h.BM:var e="auto"!==t&&"zh"!==t&&"en"!==t,i="zh"!==o&&"en"!==o;
return e||i;case h.ET:case h.WCM:var d=void 0,r=void 0;return"auto"===t?(d=!1,r="en"!==o&&"zh"!==o):"zh"===t?(d=!1,r="en"!==o):(d=!0,r=!0),d||r
}}function m(){L.find("[data-domain-value]").removeClass("active").end().find('[data-domain-value="'+C+'"]').addClass("active"),b.find(".domain-trans-bottom .active").length>0&&b.find(".domain-trans-bottom").append(b.find(".domain-trans-top .domain-trans-item-wrapper").eq(1)).end().find(".domain-trans-top").append(b.find(".domain-trans-bottom .active").parent()),T.find(".domain-trans-bottom .active").length>0&&T.find(".domain-trans-bottom").append(T.find(".domain-trans-top .domain-trans-item-wrapper").eq(0)).end().find(".domain-trans-top").append(T.find(".domain-trans-bottom .active").parent()),b.toggleClass("domain-trans-hot",b.find(".domain-trans-top .domain-trans-bm").length>0),T.toggleClass("domain-trans-hot",T.find(".domain-trans-top .domain-trans-bm").length>0),$(".output-wrap").attr("data-domain-value",C),e()
}function l(a){var n=a.fromLang,t=a.toLang;Object.values(h).forEach(function(a){var o=s({domain:a,fromLang:n,toLang:t});L.find('[data-domain-value="'+a+'"]').toggleClass("disable",o)
})}function u(){$("body").on("updateFromTo.domainTrans",function(a,n){var t=void 0,o=void 0;if(null==n?(t=$(".select-from-language .language-selected").attr("data-lang"),o=$(".select-to-language .language-selected").attr("data-lang")):(t=n.fromLang,o=n.toLang),s({domain:C,fromLang:t,toLang:o})){C=h.COMMON;
var e=L.find(".domain-trans-common"),i=L.find(".domain-trans-common .domain-trans-item-tip span");e.addClass("reset"),i.text(s({domain:h.BM,fromLang:t,toLang:o})?"当前语种仅支持通用领域":"当前语种仅支持通用领域、生物医药领域"),setTimeout(function(){e.removeClass("reset")
},3e3),m()}l({fromLang:t,toLang:o})}).on("click",".domain-trans-item",function(){var a=$(this),n=String(a.data("domainValue"));
C===n||a.hasClass("disable")||(C=n,m(),v.onTranslate({transtype:"translang"}))}).on("click",".domain-trans-tip-close",function(){L.find(".domain-trans-tip").hide()
}).on("click",".domain-trans-toast-close",function(){return i()})}function c(){u();var a=$(".select-from-language .language-selected").attr("data-lang"),n=$(".select-to-language .language-selected").attr("data-lang");
l({fromLang:a,toLang:n}),setTimeout(function(){try{var a=localStorage.getItem("DOMAIN_TRANS_TIP_FLAG");if("yes"===a)return;
localStorage.setItem("DOMAIN_TRANS_TIP_FLAG","yes"),L.find(".domain-trans-tip").show(),setTimeout(function(){L.find(".domain-trans-tip").hide()
},5e3)}catch(n){L.find(".domain-trans-tip").show(),setTimeout(function(){L.find(".domain-trans-tip").hide()},5e3)}},16)}function f(){L.show(),$(".output-wrap").attr("data-domain-value",C)
}function g(){L.hide(),$(".output-wrap").attr("data-domain-value","")}var p,v=a("translation:widget/translate/input/translate"),h={COMMON:"common",BM:"medicine",ET:"electronics",WCM:"mechanics"},M=(p={},o(p,h.COMMON,"通用领域"),o(p,h.BM,"生物医药"),o(p,h.ET,"电子科技"),o(p,h.WCM,"水利机械"),p),C=h.COMMON,L=$(".domain-trans-wrapper"),b=$(".domain-trans-large"),T=$(".domain-trans-small"),w=$(['<div class="domain-trans-toast">','<div class="domain-trans-toast-text"></div>','<div class="domain-trans-toast-close"></div>',"</div>"].join("")),O=null;
t.exports={getCurDomain:r,log:d,show:f,hide:g},$(function(){c()})});
;define("translation:widget/translate/docTranslate/docTransUtil",function(e,t){"use strict";var n=e("translation:widget/translate/input/uploader"),a=e("translation:widget/common/environment"),r=e("translation:widget/translate/domain/domain"),o=$(".doc-trans-view-wrap .progress-bar"),i=$(".doc-trans-view-wrap"),s=i.find(".src-doc-padding-wrapper, .dst-doc-padding-wrapper"),d=i.find(".export-tip"),l=i.find(".doc-async-translating-tip"),c=$("#doc-view-iframe"),p=/^\/docViewMode\?name=(.+)&from=(\w+)&to=(\w+)&token=(\w+)$/,f={file:null,fileName:"",from:"",to:"",token:"",translatingParaIdxSet:new Set};
t.isSupportByDocTrans=function(e){var t=e.name;if("string"!=typeof t)return!1;var n=t.split(".");if(1===n.length)return!1;
var a=n[n.length-1],r=["doc","docx","xls","xlsx","ppt","pptx"];return window.common.pdfHit&&r.push("pdf"),-1!==r.indexOf(a)
},t.currTask=f;var g={percentage:0,uploadSuccess:function(){this.percentage=30,o.css("transform","scaleX("+this.percentage/100+")")
},reset:function(){this.percentage=0,o.removeAttr("style")},add:function(){this.percentage+30<95&&(this.percentage=this.percentage+30,o.css("transform","scaleX("+this.percentage/100+")"))
},complete:function(){this.percentage=100,o.css("transform","scaleX("+this.percentage/100+")")}};t.progress=g,t.clearDocTrans=function(e){r.show(),$("#main-outer").removeClass("doc-trans-mode").removeClass("doc-trans-view-mode"),$(".doc-trans-file").text(""),window.common.docHit&&!a.get("isInRtTransState")&&0===$("#baidu_translate_input").val().length&&($("#upload-btn").show(),window.hasStatUploadBtnShow||(_hmt.push(["_trackEvent","首页","74_首页页面_上传文档按钮展示"]),window.hasStatUploadBtnShow=!0)),f.file&&n.cancelFile(f.file),f.fileName="",f.from="",f.to="",f.token="",f.translatingParaIdxSet.clear(),delete f.translatedSpanCounter,delete f.detectedFrom,delete f.detectedTo,delete f.isOverflow,delete f.isOriginalOverflow,delete f.url,delete f.isHtml;
var t=$(".doc-trans-view-wrap");t.find(".loading-container, .loading-err-container, .loading-exit-btn").removeAttr("style"),t.find(".export-doc-btn").removeClass("generating").prop("data-has-gen-link",!1),t.removeClass("loading viewing-html viewing-file"),d.hide(),l.hide(),$("#doc-specified-style").remove(),s.empty(),c.attr("src",""),g.reset(),e&&$("#upload-btn-hidden").find('input[type="file"]').click(),$(".footer").show()
...
},t.clearDocTransViewMode=function(){i.find(".file-name").text(""),i.find(".doc-view-from-lang").text(""),i.find(".doc-view-to-lang").text(""),i.find(".loading-container").removeAttr("style"),i.find(".loading-err-container").removeAttr("style"),i.removeClass("loading viewing-html viewing-file"),c.attr("src",""),g.reset(),$("#main-outer").removeClass("doc-trans-view-mode"),d.hide(),l.hide(),$(".footer").show()
},t.viewModeRegExp=p,t.logWrongFileFormat=function(e){var t="未知格式";if(e&&e.name){var n=e.name.split(".");n.length>1&&(t=n[n.length-1])
...
u.removeClass("selected"),u.filter('[data-dir="'+t+'"]').addClass("selected");var e="auto2auto"===t;l.toggleClass("auto",e),e?l.find(".from-doc-lang").text("中英互译"):(l.find(".from-doc-lang").text(d[n].zhName),l.find(".to-doc-lang").text(d[r].zhName)),c.removeClass("open"),g.from=n,g.to=r
}function a(t){return{from:t.split("2")[0],to:t.split("2")[1]}}function n(){s.removeClass("guiding"),localStorage.setItem("docTransLangGuideFlag","true")
}var r=Object.assign||function(t){for(var o=1;o<arguments.length;o++){var a=arguments[o];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(t[n]=a[n])
}return t},e=t("translation:widget/translate/input/uploader"),i=t("translation:widget/translate/docTranslate/docTransUtil"),d=t("translation:widget/common/config/langMap"),s=$(".doc-trans-operation"),c=$(".doc-trans-dir"),l=c.find(".curr-doc-dir"),m=c.find(".doc-lang-select"),u=m.find(".doc-lang-pair"),f=m.find(".know-btn"),g={from:"auto",to:"auto"};
!function(){var a=localStorage.getItem("docTransDir");a&&o(a),$(".doc-trans-btn").on("click",function(){window.common.docLangHit?e.option("formData",r({},g,{sid:1152020})):window.common.domainHit?e.option("formData",r({},g,{sid:window.common.docSid})):e.option("formData",g),e.upload(i.currTask.file),Object.assign(i.currTask,g);
var o=t("translation:widget/translate/docTranslate/docTranslate");o.loading(),$("#main-outer").removeClass("doc-trans-mode").addClass("doc-trans-view-mode"),$(".footer").hide(),window._hmt.push(["_trackEvent","首页","80_首页页面_点击文档翻译的翻译按钮"]),"auto"===g.from&&"auto"===g.to&&window._hmt.push(["_trackEvent","首页","81_首页页面_点击文档翻译的翻译按钮时语言方向为中英互译"])
}),l.on("click",function(){c.toggleClass("open"),n()}),u.on("click",function(t){var a=$(t.currentTarget).attr("data-dir");
localStorage.setItem("docTransDir",a),o(a),n()}),f.on("click",function(){n(),c.removeClass("open")}),$("body").on("click",function(t){var o=$(t.target);
...
;define("translation:widget/translate/setting/setting",function(e){"use strict";var t=e("translation:widget/common/environment"),s=e("translation:widget/common/cookie"),o=e("translation:widget/login/login"),i=e("translation:widget/translate/history/history"),n=e("translation:widget/common/util"),r=e("translation:widget/translate/output/adcards"),d={init:function(){this.initSetting(),this.bindEvents()
...
var d=s.getCookie("HISTORY_SWITCH");d?"0"===d?($(".history-switch").removeClass("setting-checked"),t.set("isInHistoryMode",!1),r.updateAppSideAdLong()):"1"===d&&(t.set("isInHistoryMode",!0),r.updateAppSideAdLong()):(s.setCookie("HISTORY_SWITCH",1,{expires:864e8}),t.set("isInHistoryMode",!0),r.updateAppSideAdLong());
var a=s.getCookie("SOUND_SPD_SWITCH");a?"0"===a?($("#spd-slow").addClass("sound-spd-radio-checked"),t.set("soundSpdMode","slow")):"2"===a?($("#spd-fast").addClass("sound-spd-radio-checked"),t.set("soundSpdMode","fast")):($("#spd-normal").addClass("sound-spd-radio-checked"),t.set("soundSpdMode","normal")):(s.setCookie("SOUND_SPD_SWITCH",1,{expires:864e8}),$("#spd-normal").addClass("sound-spd-radio-checked"),t.set("soundSpdMode","normal"));
var c=s.getCookie("SOUND_PREFER_SWITCH");c?"0"===c?($("#prefer-uk").addClass("sound-prefer-radio-checked"),t.set("soundPreferMode","uk")):($("#prefer-en").addClass("sound-prefer-radio-checked"),t.set("soundPreferMode","en")):(s.setCookie("SOUND_PREFER_SWITCH",1,{expires:864e8}),$("#prefer-en").addClass("sound-prefer-radio-checked"),t.set("soundPreferMode","en"));
var l=n.supportLocalStorage?localStorage.getItem("soundTrigger"):"";l||(l="hover",n.supportLocalStorage&&localStorage.setItem("soundTrigger",l)),$("#"+l+"-trigger").addClass("sound-trigger-radio-checked"),t.set("soundTriggerMode",l)
...
},setHistorySwitch:function(){var e=$(".history-switch");e.toggleClass("setting-checked");var o;e.hasClass("setting-checked")?(o=1,t.set("isInHistoryMode",!0),r.updateAppSideAdLong(),_hmt.push(["_trackEvent","首页","设置-历史记录-开启"])):(o=0,t.set("isInHistoryMode",!1),r.updateAppSideAdLong(),_hmt.push(["_trackEvent","首页","设置-历史记录-关闭"])),i.onHistoryInput(),s.setCookie("HISTORY_SWITCH",o,{expires:864e8})
...
;define("translation:widget/translate/translang/translang",function(t){"use strict";t("translation:node_modules/react-app-polyfill/ie11"),t("translation:node_modules/react-app-polyfill/stable");
var n=(t("translation:widget/common/environment"),t("translation:widget/translate/translang/fromlang")),a=t("translation:widget/translate/translang/tolang"),e=t("translation:widget/translate/translang/exchange"),l=t("translation:widget/translate/translang/transbtn"),s=t("translation:widget/translate/translang/langPanelContainer.jsx"),i={init:function(){this.bindEvents()
},bindEvents:function(){$(".trans-operation-wrapper").on("click",".select-from-language",$.proxy(this.clickFromBtn,this)).on("click",".select-to-language",$.proxy(this.clickToBtn,this)).on("click",".from-to-exchange",$.proxy(this.clickExchangeBtn,this)),$("#translate-button").on("click",$.proxy(this.clickTranslate,this)),$(".manual-trans-btn").on("click",function(){_hmt.push(["_trackEvent","首页","web端点击人工翻译按钮"])
}),$(".manual-trans-btn .expert-logo").on("click",function(){_hmt.push(["_trackEvent","首页","web端点击人工翻译文字链左侧小人头像进入首页的次数"])
}),$(document).on("click",$.proxy(this.clickBody,this))},clickFromBtn:function(){s.fromBtnClicked(),_hmt.push(["_trackEvent","首页","web端点击源语言button"])
},clickToBtn:function(){s.toBtnClicked(),_hmt.push(["_trackEvent","首页","web端点击目标语言button"])},clickExchangeBtn:function(){e.clickExchangeBtn(),_hmt.push(["_trackEvent","首页","点击翻译方向切换箭头"])
},clickTranslate:function(){l.transBtnClicked(),_hmt.push(["_trackEvent","首页","web端翻译button点击次数"])},clickBody:function(t){var e=$(t.target);
1===s.getCurrLangType()&&(e.hasClass("select-from-language")||e.parents(".select-from-language").length>0||e.hasClass("lang-panel-from")||e.parents(".lang-panel-from").length>0)||n.hideFromWrap(),2===s.getCurrLangType()&&(e.hasClass("select-to-language")||e.parents(".select-to-language").length>0||e.hasClass("lang-panel-to")||e.parents(".lang-panel-to").length>0)||a.hideToWrap()
}};$(function(){i.init()})});
...
;define("translation:widget/footer/extra/extra",function(n,t){"use strict";function o(){var n=$(".manual-spread");return n.length>0&&!n.hasClass("manual-spread-none")?void e.css("top",.7*$(window).height()):void e.css("top",.5*$(window).height()).show()
}function i(){$(window).on("resize",o),s.on("click",a),c.on("click",function(){_hmt.push(["_trackEvent","首页","96_首页页面_右侧悬浮按钮点击"]),window.open("https://fanyi.baidu.com/appdownload/download.html")
})}function a(n){n.preventDefault(),$("html, body").animate({scrollTop:0},250),_hmt.push(["_trackEvent","index","web端回到顶部按钮点击"])
}n("translation:widget/common/util");t.init=function(){o(),i()};var e=$(".extra-wrap"),s=e.find(".backtotop-btn"),c=e.find(".sideQrContainer");
$(window).on("scroll",function(){var n=$(document).scrollTop();n>0?(s.css("display","block"),c.css("display","block"),_hmt.push(["_trackEvent","首页","95_首页页面_右侧悬浮按钮展现"])):(s.hide(),c.hide())
})});
